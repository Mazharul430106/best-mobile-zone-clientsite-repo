        ...
        <div className="card card-compact w-full bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <div className="card-actions pb-3">
                    <label onClick={()=>setModalData(iphone)} htmlFor="booking-modal" className="btn btn-primary w-full text-white"> Book Now</label>
                </div>
            </div>
        </div>
    );
